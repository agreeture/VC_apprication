...
class FC_2_HiFiGAN_Generator(torch.nn.Module):
    ...
    def __init__(
        ...
        self.fc = torch.nn.Linear(9 * 2, 2)
        self.fc_2 = torch.nn.Linear(2, 4)
    ...
    def forward(self, c):
        ...
        c = self.fc(c)
        c = self.fc_2(c)
        c = torch.reshape(c, (batch_size, 1, c.shape[1]*c.shape[2]))
