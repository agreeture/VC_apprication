...
class MS_FC_HiFiGAN_Generator(torch.nn.Module):
    ...
    def __init__(
        ...
        self.fc = torch.nn.Linear( (simple_upsample_scale_fc  * 2 + 1) * 2, simple_upsample_scale_fc)
    ...
    def forward(self, c):
        ...
        """
        #print("vocoder input shape : ",end="")
        #print(c.shape)
        c = c.squeeze().unsqueeze(dim=0)
        c = self.input_conv(c)
        #print("vocoder input shape : ",end="")
        #print(c.shape)
        ...
        #print("l : " + str(l))
        #print("c_out // l : " + str(c_out // l))
        #print("c shape after output_conv : ", end="")
        #print(c.shape)
        c = torch.reshape(c, (c.shape[0], self.subbands, (self.fc_rate * 2 + 1)*2, l))
        c = torch.transpose(c, 2, 3)
        #print("c shape befor fc : ", end="")
        #print(c.shape)
        c = self.fc(c)
        #print("c shape after fc : ", end="")
        #print(c.shape)
        c = torch.reshape(c, (c.shape[0], self.subbands, l * self.fc_rate))
        ...
        #updown_filter = torch.zeros((self.subbands, self.subbands, self.subbands)).float().to(device)
        ...
        #print("c shape after synthesis : ", end="")
        #print(c.shape)
