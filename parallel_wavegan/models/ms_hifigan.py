...
class MS_HiFiGANGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        self.subbands = 4
        self.synthesis_filter = torch.nn.Conv1d(4, 1, filter_kernel_size, 1, bias=False)
    ...
    def forward(self, c):
        ...
        #updown_filter = torch.zeros((self.subbands, self.subbands, self.subbands), device=device).float()
